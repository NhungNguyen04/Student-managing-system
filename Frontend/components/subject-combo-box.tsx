...
export default function SubjectComboBox({ setSubjectId, subjectId, subjectname }: SubjectComboBoxProps) {
  ...
  const handleChangeInput = (e: Subject) => {
    setSelected(e)
    setSubjectId(e.id)
  }
          ...
          <div className="relative w-full cursor-default overflow-hidden rounded-lg bg-white text-left shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-white/75 focus-visible:ring-offset-2 focus-visible:ring-offset-teal-300 sm:text-sm">
            <Combobox.Input
              ...
              displayValue={(subject: Subject) =>
                subject.id === "" ? subject.subjectname + subject.id : subject.subjectname + " - " + subject.id
              }
              onChange={(event) => {
